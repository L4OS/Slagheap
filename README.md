...
- разрядность шины данных и регистров: 2 бита
- количество регистров общего назначение: 16 регистров
- количество регистров сообщений: 64 регистра
- размер оперативной памяти: 32 килобайта 0
