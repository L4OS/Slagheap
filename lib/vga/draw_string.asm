; --- Точко входа при отладке. Она должна быть первой в файле
...
; --- Функция вывода символна заданным цветом в видеопамять VGA адаптера
; Вход:  R0  - указатель на строку
;	 R1  - YX - строка-столбец - старшие 16 бит номер строки, младшие 16 бит ноиер столбца
;	 R2  - цвет символа
;	 R3  - цвет фона
; Выход: 
